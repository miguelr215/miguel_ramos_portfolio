        ...
        return(
            <section id="about">
                ...
                <div className="about_container">
                    ...
                    <br />
                    I love to dig into people’s problems and solve them with technology. The passion I have for constant learning, improving and producing substantial results drives me to grow in my career as a Full Stack Developer. <br />
                    <br />
